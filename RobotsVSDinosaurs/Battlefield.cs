...
namespace RobotsVSDinosaurs
{
    class Battlefield
    {
        ...
        public void StartBattle()
        {
            ...
            Dinosaur bronto = new Dinosaur("brontosaurus", 100, 80, 5);
            Dinosaur stego = new Dinosaur("stegosaurus", 100, 75, 8);
            Robot blueRobot = new Robot("caboose", 100, 100, new Weapon("Energy Sword", 15));
            ...
            while ((dinos.listOfDinos[0].isAlive != false || dinos.listOfDinos[1].isAlive != false || dinos.listOfDinos[2].isAlive != false) || (robots.listOfRobots[0].isAlive != false || robots.listOfRobots[1].isAlive != false || robots.listOfRobots[2].isAlive != false))
            {
